...
export default function WaterProodingproductsPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
    }, []); 
    return (
        ...
        <table>
          ...
          <p >
            ...
            Scientist technologist modified the bitumen with Attactic Polypropylene. This development causes revolutionary changes in concept of waterproofing. Physical characteristics of bitumen with this modification has change drastically. The Softening point goes more then 150<sup>0</sup>C and Cold flexibility increases up to -15<sup>0</sup>C.
          </p>
          <ul>
            <p>
          ...
          <p> 
            ...
            Liquid applied acrylic coatings are highly flexible, high elongation, heat resistance, UV protective and low permeability to water. The products are widely used in waterproofing of terrace, slopping roofs, top coat over EMB coating, balconies,wet area etc.</p>
          <p>
